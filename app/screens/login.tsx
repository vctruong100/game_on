    ...
    >
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.optionsRow}>
          ...
          >
            <AntDesign
              name={biometrics ? 'checksquare' : 'checksquareo'}
              size={20}
              color={biometrics ? C.primary : C.icon}
            />
            <Text style={styles.checkText}>Biometrics</Text>
          </TouchableOpacity>
          ...
          >
            <AntDesign
              name={remember ? 'checksquare' : 'checksquareo'}
              size={20}
              color={remember ? C.primary : C.icon}
            />
